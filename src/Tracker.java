...
public class Tracker {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(String candidate : l1) {
			...
			if(l3.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file3);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file3);
			...
			if(l4.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file4);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file4);
			...
			if(l5.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file5);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file5);
			...
			if(l6.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file6);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file6);
			...
			if(l7.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file7);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file7);
			...
			if(l8.contains(candidate)) {
				if(results.containsKey(candidate)) {
					results.get(candidate).add(file1);
					results.get(candidate).add(file8);
				} else {
					results.put(candidate, new HashSet<>());
					results.get(candidate).add(file1);
					results.get(candidate).add(file8);
